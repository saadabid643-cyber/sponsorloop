...
import { X, User, Building2, Mail, Lock, Eye, EyeOff, Upload, Camera, MapPin, Globe, Instagram, Twitter, Linkedin, Facebook } from 'lucide-react';
              ...
              <div className="mt-6">
                ...
                <div className="mt-4 space-y-3">
                  ...
                  <button
                    type="button"
                    onClick={() => {
                      // This would trigger Facebook sign-up
                      window.dispatchEvent(new CustomEvent('facebookSignUp'));
                    }}
