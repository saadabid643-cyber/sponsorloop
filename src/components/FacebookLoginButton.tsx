...
const FacebookLoginButton: React.FC<FacebookLoginButtonProps> = ({
  ...
  const handleFacebookLogin = () => {
    ...
    window.FB.login((response: any) => {
      ...
      scope: 'email,public_profile,instagram_basic,pages_show_list,instagram_manage_insights,instagram_manage_comments,instagram_content_publish,pages_read_engagement,pages_read_user_content,business_management',
      return_scopes: true 
    });
  };
